...
```
Для установки плагинов будем использовать **Vim Plug**. Установим **Vim Plug**:
```bash
...
```
Вставляем в конфигурационный файл следующее содержимое:
```bash
...
```
Установим LSP сервер для Python (pyright):
```bash
